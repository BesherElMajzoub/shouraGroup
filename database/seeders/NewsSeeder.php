...
class NewsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $news = [
            [
                'cat_slug' => 'agencies',
                'title_ar' => 'إضافة نوعية جديدة: وصول مضخات EMS PUMP التركية لأول مرة إلى صالاتنا',
                'slug' => 'ems-pump-arrival',
                'excerpt_ar' => 'في إطار سعينا الدائم لتوسيع محفظة منتجاتنا وتلبية كافة الاحتياجات الهندسية بأسعار تنافسية وجودة عالية، تعلن مجموعة شركة شورى إخوان عن توفير مضخات EMS PUMP التركية العريقة لأول مرة في السوق...',
                'body_ar' => "يسر مجموعة شركة شورى إخوان أن تزف لعملائها في القطاعين الصناعي والزراعي خبر وصول الدفعة الأولى من مضخات EMS PUMP التركية الرائدة إلى صالات العرض ومستودعاتنا.\n\nتأتي هذه الخطوة الاستراتيجية لتوفير حلول ضخ متنوعة وموثوقة تواكب متطلبات المشاريع الحديثة، وتتميز منتجات EMS بمتانتها وكفاءتها العالية في استهلاك الطاقة.\n\nندعوكم لزيارة فروعنا في دمشق وحلب للاطلاع على التشكيلة الجديدة والمواصفات الفنية، حيث يقف فريقنا الهندسي جاهزاً لتقديم الاستشارة واختيار المضخة الأنسب لمشاريعكم.",
