    ...
    <footer id="contact" class="scroll-mt-24 bg-[#141414] text-white relative overflow-hidden">
        ...
        <div class="relative mx-auto max-w-7xl px-4 sm:px-6 py-14 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            <div class="lg:col-span-1">
                ...
                <div class="flex items-center gap-3">
                    @foreach (['facebook' => 'https://www.facebook.com/share/1HYQzeysTg/', 'instagram' => 'https://www.instagram.com/shoragroup.co?stkn=eGo4angzMnZieXM2', 'x' => '#'] as $s => $socialUrl)
                        <a href="{{ $socialUrl }}" @if ($socialUrl !== '#') target="_blank" rel="noopener noreferrer" @endif aria-label="{{ $s }}" class="w-9 h-9 rounded-full bg-white/10 hover:bg-brand grid place-items-center transition-colors">
                            @if ($s === 'facebook')
