    ...
    <section class="relative overflow-hidden bg-white border-b border-gray-100">
        ...
        <div class="relative mx-auto max-w-7xl px-4 sm:px-6 py-10 lg:py-14">
            <nav class="text-sm text-[#888] mb-4 flex items-center gap-2">
                ...
                <span class="text-[#141414] font-medium">قصتنا</span>
            </nav>
            <span class="inline-block text-brand font-bold text-xs tracking-widest uppercase mb-3">مسيرتنا منذ الانطلاقة</span>
            <h1 class="text-3xl sm:text-4xl font-black text-[#141414] mb-3">قصة شورى</h1>
            <p class="max-w-xl text-[#555] leading-loose text-[15px]">
                من فكرة طموحة إلى مجموعة شركات رائدة؛ هذه رحلة شورى في بناء الثقة وتقديم
                الحلول المتكاملة لخدمة سوريا وأهلها.
            </p>
        </div>
    </section>
