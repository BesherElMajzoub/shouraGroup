...
@section('content')
    ...
    @include('partials.page-header', [
        'current' => 'المنتجات',
        'eyebrow' => 'تجهيزات ومعدات أصلية ومكفولة',
        'title'   => 'منتجاتنا',
        'desc'    => 'نوفر لعملائنا في سوريا تشكيلة واسعة من أفضل الأنظمة والتجهيزات المائية ومعدات المسابح والمواد الكيميائية المستوردة من أرقى العلامات التجارية العالمية.',
    ])
