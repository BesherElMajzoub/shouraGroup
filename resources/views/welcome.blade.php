...
@section('content')
    ...
    @php
        $chips = [
            ['label' => 'شورى للمياه',    'top' => 6,  'left' => 10, 'size' => 5.5, 'r' => -8, 'd' => 0.0],
            ['label' => 'شورى للمسابح',   'top' => 14, 'left' => 78, 'size' => 6,   'r' => 6,  'd' => 0.6],
            ['label' => 'شورى للمقاولات', 'top' => 2,  'left' => 44, 'size' => 4.5, 'r' => 4,  'd' => 1.2],
            ['label' => 'شورى للصيانة',   'top' => 40, 'left' => 4,  'size' => 5,   'r' => 10, 'd' => 0.3],
            ['label' => 'شورى للتجارة',   'top' => 46, 'left' => 88, 'size' => 4.5, 'r' => -6, 'd' => 0.9],
            ['label' => 'شريك 6',         'top' => 70, 'left' => 14, 'size' => 4,   'r' => -12,'d' => 1.5],
            ['label' => 'شريك 7',         'top' => 76, 'left' => 70, 'size' => 5,   'r' => 8,  'd' => 0.4],
            ['label' => 'شريك 8',         'top' => 24, 'left' => 26, 'size' => 4,   'r' => 12, 'd' => 1.1],
            ['label' => 'شريك 9',         'top' => 30, 'left' => 62, 'size' => 4.5, 'r' => -10,'d' => 0.7],
        ];
    @endphp
        ...
        <div class="relative mx-auto max-w-7xl px-4 sm:px-6 py-16 lg:py-28">
            <div class="flex flex-col items-center text-center">
                ...
                <h1 class="text-3xl sm:text-5xl font-black text-[#141414] leading-tight anim-fade-up" style="animation-delay:.15s">
                    مجموعة <span class="text-brand">شورى</span>
                </h1>
                <p class="mt-4 max-w-2xl text-base sm:text-lg text-[#4b4b4b] leading-relaxed anim-fade-up" style="animation-delay:.3s">
                    مجموعة شركات سورية رائدة، تجمع خبرات متكاملة في المياه والمسابح والمقاولات والتجارة
                    لخدمة عملائها في مختلف المحافظات السورية.
                </p>
    ...
    <section id="about" class="scroll-mt-24 py-20 lg:py-28 bg-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div class="reveal">
                <span class="inline-block text-brand font-bold text-sm mb-3">مجموعة شورى</span>
                ...
                <div class="space-y-4 text-[#4b4b4b] leading-loose text-[15px]">
                    <p>
                        شورى هي إحدى المجموعات السورية الرائدة في مجال المياه والمسابح والمقاولات،
                        تأسست لتقديم حلول متكاملة بأعلى معايير الجودة والاحترافية.
                    </p>
                    <p>
                        تضمّ المجموعة عدداً من الشركات المتخصصة التي تعمل معاً لتقديم خدمات شاملة
                        لعملائها، من التصميم والتنفيذ إلى الصيانة والتشغيل في مختلف المحافظات السورية.
                    </p>
                    <p>
                        نسعى دائماً لأن نكون الخيار الأول لعملائنا من خلال فريق عمل مؤهّل وخبرة
                        تراكمية تجعل من شورى اسماً موثوقاً في السوق.
                    </p>
                </div>
                <div class="mt-8 grid grid-cols-3 gap-4 max-w-md">
                    @foreach (['+15' => 'سنة خبرة', '+50' => 'مشروع منجز', '+5' => 'شركات متخصصة'] as $num => $lbl)
    ...
    @php
        $services = [
            ['title' => 'أنظمة معالجة المياه', 'desc' => 'حلول متكاملة لتحلية ومعالجة وفلترة المياه للمشاريع السكنية والصناعية بأحدث التقنيات.', 'icon' => 'M12 3c-3.5 4-6 7.2-6 10.5a6 6 0 0 0 12 0C18 10.2 15.5 7 12 3Z'],
            ['title' => 'تصميم وتنفيذ المسابح', 'desc' => 'تصميم وبناء وتجهيز المسابح بمختلف أنواعها مع أنظمة التنقية والإضاءة والتدفئة.', 'icon' => 'M3 18c1.5 0 1.5-1 3-1s1.5 1 3 1 1.5-1 3-1 1.5 1 3 1 1.5-1 3-1 1.5 1 3 1M3 14c1.5 0 1.5-1 3-1s1.5 1 3 1 1.5-1 3-1 1.5 1 3 1 1.5-1 3-1 1.5 1 3 1M6 10V5a2 2 0 0 1 4 0M14 10V5a2 2 0 0 1 4 0'],
            ['title' => 'المقاولات العامة', 'desc' => 'تنفيذ المشاريع الإنشائية والمدنية بإدارة احترافية وجودة عالية والتزام بالمواعيد.', 'icon' => 'M3 21h18M5 21V7l7-4 7 4v14M9 21v-6h6v6M9 11h.01M15 11h.01'],
            ['title' => 'الصيانة والتشغيل', 'desc' => 'عقود صيانة دورية وتشغيل للأنظمة والمحطات لضمان استمرارية الأداء وكفاءته.', 'icon' => 'M11.4 2.6a5 5 0 0 0 6 6L21 12l-2 2-3.4-3.4a5 5 0 0 1-6-6L7 1l4.4 1.6ZM3 17l6-6M3 17l3 3 6-6'],
            ['title' => 'توريد المعدات والمواد', 'desc' => 'توفير المضخات والفلاتر والمواد الكيميائية ومستلزمات المياه والمسابح من ماركات عالمية.', 'icon' => 'M3 9l9-6 9 6v9a2 2 0 0 1-2 2h-5v-6H10v6H5a2 2 0 0 1-2-2V9Z'],
            ['title' => 'الاستشارات الهندسية', 'desc' => 'دراسات وتصاميم واستشارات هندسية متخصصة تساعدك على اتخاذ القرار الأمثل لمشروعك.', 'icon' => 'M9 3v2m6-2v2M9 19v2m6-2v2M3 9h2m-2 6h2m14-6h2m-2 6h2M7 7h10v10H7z'],
        ];
    @endphp
    <section id="services" class="scroll-mt-24 py-20 lg:py-28 bg-[#f7f7f8]">
        <div class="mx-auto max-w-7xl px-4 sm:px-6">
            <div class="text-center max-w-2xl mx-auto mb-14 reveal">
                ...
                <h2 class="text-3xl sm:text-4xl font-black text-[#141414] mb-4">الخدمات التي تقدّمها شورى</h2>
                <p class="text-[#4b4b4b] leading-relaxed">
                    باقة متكاملة من الخدمات المتخصصة التي تغطّي دورة حياة مشروعك من البداية حتى التشغيل.
                </p>
            </div>
            ...
            <div class="lg:w-[46%] space-y-14">
                <div class="reveal flex items-start gap-7">
                    <div class="flex-1 pt-2">
                        ...
                        <p class="text-[#4b4b4b] leading-loose text-[15px]">
                            تحقيق الريادة في السوق السوري عبر منتجات وخدمات ذات جودة عالية،
                            بحضور محلي وإقليمي يواكب أحدث المعايير العالمية.
                        </p>
                    </div>
                ...
                <div class="reveal flex items-start gap-7" style="transition-delay:.15s">
                    <div class="flex-1 pt-2">
                        ...
                        <p class="text-[#4b4b4b] leading-loose text-[15px]">
                            تقديم حلول ومنتجات متكاملة بأعلى معايير الجودة والاحترافية في جميع
                            قطاعاتها، عبر فريق مؤهّل وشراكات موثوقة تحقّق رضا عملائنا.
                        </p>
                    </div>
    ...
    @php
        $companies = [
            ['name' => 'شورى للمياه',    'tag' => 'معالجة وتحلية المياه',  'desc' => 'حلول متكاملة لمعالجة وفلترة وتحلية المياه للقطاعين السكني والصناعي.'],
            ['name' => 'شورى للمسابح',   'tag' => 'تصميم وتنفيذ المسابح',  'desc' => 'تصميم وبناء وتجهيز المسابح بأنظمة تنقية وإضاءة وتدفئة حديثة.'],
            ['name' => 'شورى للمقاولات', 'tag' => 'مقاولات عامة',          'desc' => 'تنفيذ المشاريع الإنشائية والمدنية بجودة عالية والتزام بالمواعيد.'],
            ['name' => 'شورى للصيانة',   'tag' => 'صيانة وتشغيل',          'desc' => 'عقود صيانة وتشغيل دورية للأنظمة والمحطات لضمان كفاءة الأداء.'],
            ['name' => 'شورى للتجارة',   'tag' => 'توريد ومعدات',          'desc' => 'توريد المضخات والفلاتر والمواد ومستلزمات المياه والمسابح.'],
        ];
    @endphp
    ...
    @php
        ...
        $right = [
            ['t' => 'تنفيذ وصيانة محطات تحلية ومعالجة المياه', 'i' => $iconWater],
            ['t' => 'تصميم وتنفيذ المسابح بمختلف أنواعها', 'i' => $iconPool],
            ['t' => 'المقاولات العامة والأعمال الإنشائية', 'i' => $iconBuild],
            ['t' => 'توريد وتركيب أنظمة الإنذار ومكافحة الحرائق', 'i' => $iconFire],
        ];
        $left = [
            ['t' => 'توريد المضخات والفلاتر ومستلزمات المياه', 'i' => $iconPump],
            ['t' => 'أعمال الصرف الصحي وشبكات المياه', 'i' => $iconPipe],
            ['t' => 'الصيانة الدورية وتشغيل الأنظمة', 'i' => $iconWrench],
            ['t' => 'الاستشارات والدراسات الهندسية المتخصصة', 'i' => $iconPlan],
        ];
    @endphp
                ...
                <div class="order-1 lg:order-2 reveal">
                    <div class="relative w-72 h-72 sm:w-80 sm:h-80 mx-auto">
                        ...
                        <div class="absolute top-6 inset-x-0 flex items-center justify-center gap-3">
                            <span class="text-6xl font-black text-brand leading-none">+15</span>
                            <span class="text-sm font-bold text-[#141414] leading-tight text-right">عاماً من<br>النمو المستدام</span>
                        </div>
                    </div>
                </div>
    ...
    @php
        $branches = [
            ['name' => 'وحدة دمشق – المرجة',    'addr' => 'دمشق، ساحة المرجة',              'phone' => '+963 11 234 5678', 'top' => 78, 'left' => 9],
            ['name' => 'وحدة برامكة – الجمارك', 'addr' => 'دمشق، البرامكة – قرب الجمارك',   'phone' => '+963 11 876 5432', 'top' => 64, 'left' => 15],
        ];
    @endphp
    <section id="branches" class="scroll-mt-24 py-20 lg:py-28 bg-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6">
            <div class="text-center max-w-2xl mx-auto mb-14 reveal">
                ...
                <h2 class="text-3xl sm:text-4xl font-black text-[#141414]">فروع شركتنا</h2>
                <p class="text-[#4b4b4b] mt-3">نخدم عملاءنا في سوريا من خلال فروعنا المنتشرة.</p>
            </div>
    ...
    {{-- ============ 11) CLIENTS — عملاؤنا ============ --}}
    @php
        // عملاؤنا — استبدل النصوص بشعارات حقيقية بوضع ملفات PNG/SVG في public/images/clients/
        $clients = [
            ['name' => 'وزارة الموارد المائية', 'logo' => 'client1.png'],
            ['name' => 'مؤسسة مياه دمشق',       'logo' => 'client2.png'],
            ['name' => 'جامعة دمشق',            'logo' => 'client3.png'],
            ['name' => 'مدينة الأسد الرياضية',  'logo' => 'client4.png'],
            ['name' => 'فنادق الشام',           'logo' => 'client5.png'],
            ['name' => 'مشفى الشامي',           'logo' => 'client6.png'],
            ['name' => 'مجمع يلبغا التجاري',    'logo' => 'client7.png'],
            ['name' => 'مصنع ألبان حماة',       'logo' => 'client8.png'],
            ['name' => 'بلدية اللاذقية',        'logo' => 'client9.png'],
            ['name' => 'مدارس المستقبل',        'logo' => 'client10.png'],
        ];
    @endphp
            ...
            <div class="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
                ...
                <div class="lg:col-span-4 text-right reveal">
                    ...
                    <p class="text-[#4b4b4b] leading-loose">
                        نفخر بثقة نخبة من الجهات الحكومية والخاصة التي رافقناها في مشاريعها،
                        ونحرص على تقديم حلول وخدمات عالية الجودة ترقى لتطلّعات عملائنا في مختلف القطاعات.
                    </p>

                    {{-- مؤشرات الثقة --}}
                    <div class="flex items-center gap-8 mt-8">
                        <div>
                            <div class="text-3xl font-black text-brand leading-none">+200</div>
                            <div class="text-xs text-[#9a9a9a] mt-1.5">عميل يثق بنا</div>
                        </div>
