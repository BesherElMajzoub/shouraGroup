...
@section('title', 'إضافة إحصائية')
@section('page_title', 'إضافة رقم إحصائي جديد')
...
@section('admin_content')
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <form action="{{ route('admin.stats.store') }}" method="POST" class="bg-white rounded-2xl shadow-sm ring-1 ring-black/5 p-6 md:p-8 space-y-6 text-right">
            @csrf
