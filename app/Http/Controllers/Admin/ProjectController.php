...
class ProjectController extends Controller
{
    ...
    private function rules(): array
    {
        return [
            ...
            'client_en' => ['required_with:client_ar', 'nullable', 'string', 'max:255'],
            'location_ar' => ['nullable', 'string', 'max:255'],
            'location_en' => ['required_with:location_ar', 'nullable', 'string', 'max:255'],
            'year' => ['nullable', 'string', 'max:100'],
            'status_ar' => ['nullable', 'string', 'max:255'],
            'status_en' => ['required_with:status_ar', 'nullable', 'string', 'max:255'],
            'summary_ar' => ['nullable', 'string'],
            'summary_en' => ['required_with:summary_ar', 'nullable', 'string'],
            'description_ar' => ['nullable', 'string'],
            'description_en' => ['required_with:description_ar', 'nullable', 'string'],
            'challenge_ar' => ['nullable', 'string'],
            'challenge_en' => ['required_with:challenge_ar', 'nullable', 'string'],
            'solution_ar' => ['nullable', 'string'],
            'solution_en' => ['required_with:solution_ar', 'nullable', 'string'],
            'scope_ar' => ['nullable', 'string'],
            'scope_en' => ['required_with:scope_ar', 'nullable', 'string'],
            'equipment_ar' => ['nullable', 'string'],
            'equipment_en' => ['required_with:equipment_ar', 'nullable', 'string'],
            'duration_ar' => ['nullable', 'string', 'max:255'],
            'duration_en' => ['required_with:duration_ar', 'nullable', 'string', 'max:255'],
            'results_ar' => ['nullable', 'string'],
            'results_en' => ['required_with:results_ar', 'nullable', 'string'],
            ...
            'gallery_caption_en.*' => ['required_with:gallery_caption_ar.*', 'nullable', 'string', 'max:1000'],
            ...
            'existing_caption_en.*' => ['required_with:existing_caption_ar.*', 'nullable', 'string', 'max:1000'],
